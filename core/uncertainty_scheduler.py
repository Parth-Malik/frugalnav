...
if __name__ == "__main__":
    ...
    #    NB: a realistic drifting state raises SEVERAL cues together (position AND
    #    heading covariance grow, the image blurs, the gyro bias creeps) -- that is
    #    what carries U over tau. sigma_pos alone at 1.2 m is only ~0.35, by design:
    #    the leading indicators are what let U fire *before* sigma_pos hits the hard
    #    floor. (The C++ port cross-check flagged an earlier too-sparse test case.)
