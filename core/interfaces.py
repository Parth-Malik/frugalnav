...
class SensorInput:
    ...
    def __post_init__(self):
        # np.array() copies (unlike np.asarray) so the struct never aliases caller memory.
...
class VioOutput:
    ...
    Compose as: pose_new = pose_prev @ delta_pose."""
...
class VelocityCmd:
    ...
    Controller rotates the world-frame error via the estimate's rotation."""
